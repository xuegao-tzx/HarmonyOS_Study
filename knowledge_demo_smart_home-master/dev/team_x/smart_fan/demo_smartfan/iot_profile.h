...
typedef enum {
    ...
    CLOUD_COMMAND_SETFAN,
    CLOUD_COMMAND_SET_SPEEDLEVEL,
    CLOUD_COMMAND_LAST,
}CLOUD_CommandType;
 ...
 * @param mainFanStatus indicates the main led on/off
 * @param speedLevel indicates the duty cycle of the pwd led on the sc1 board
 * @return Returns 0 success while -1 failed
 *
 */

...
public class AccountNameChangeAbilitySlice extends AbilitySlice implements Component.ClickedListener {
    ...
    protected void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_ability_inputname);
        initComponents();
    }

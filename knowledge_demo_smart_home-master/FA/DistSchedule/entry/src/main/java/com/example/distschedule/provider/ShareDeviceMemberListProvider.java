...
public class ShareDeviceMemberListProvider extends BaseItemProvider {
    private List<FamilyMemberResult> list;
    private AbilitySlice slice;
    private Set<String> selectMemberId;
    private boolean isAllSelected = false;

    public ShareDeviceMemberListProvider(AbilitySlice slice) {
        this.slice = slice;
    }
    ...
    public void setData(List<FamilyMemberResult> list) {

...
package com.example.distschedule.qrcode;


import com.example.distschedule.qrcode.util.PixelMapUtil;
import com.example.distschedule.qrcode.util.QRCodeUtil;
...
public class ScanBoxView extends Component implements Component.DrawTask {
    ...
    private void moveScanLine() {
        ...
        getContext().getUITaskDispatcher().delayDispatch(this::invalidate, NUMBER_20);
    }

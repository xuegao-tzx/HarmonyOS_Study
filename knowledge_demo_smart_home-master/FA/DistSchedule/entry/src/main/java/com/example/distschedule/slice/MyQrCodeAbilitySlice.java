...
public class MyQrCodeAbilitySlice extends AbilitySlice {
    ...
    private void showQrCode() {
        int size = (qrCode.getScreenResolution(getContext()).getPointXToInt()
                - (10 + 40) * 2) / 2;
        PixelMap pixelMap = MainAbilitySlice.qrCode.generateCommonQRCode(PreferencesUtil.getUserPhone(getContext()), size);
